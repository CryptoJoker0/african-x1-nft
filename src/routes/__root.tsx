  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex rounded-full bg-cyber-cyan px-5 py-2.5 text-sm font-semibold text-background hover:glow-blue"
        >
          Return home
        </Link>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/77987755-6a34-4a09-8286-ef72ee017571/id-preview-e6bff8ea--cb122840-6141-40c6-90cc-700e786800e3.lovable.app-1783365666526.png",
      },
      {
        name: "twitter:image",
        content:
